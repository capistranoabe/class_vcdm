...
cdef class Class:
    ...
    def get_current_derived_parameters(self, names):
        ...
        for name in names:
            ...
            elif name == 'a_dagger_VCDM':
                value = self.ba.a_dagger_VCDM
            elif name == 'z_dagger_VCDM':
                value = 1.0/self.ba.a_dagger_VCDM -1.0
            elif name == 'b_VCDM_ov_a1':
                value = (10.0**self.ba.log10b_VCDM)/self.ba.a1_VCDM
            elif name == 'b_VCDM':
                value = 10.0**self.ba.log10b_VCDM
            elif name == 'b2_VCDM':
                value = self.ba.b2_VCDM
            elif name == 'Lambda_s0':
                value = self.ba.Lambda_s0_VCDM    
            elif name == 'a_eq':
                value = self.ba.a_eq
            elif name == 'z_eq':
